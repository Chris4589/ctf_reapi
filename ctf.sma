...
new const FLAG_MODEL[] =			"models/tc_reCTH.mdl"
new modelIndex_flag;
...
{
	{NULL, "red_flag_taken2", "blue_flag_taken2"},
	{NULL, "red_flag_dropped2", "blue_flag_dropped2"},
	{NULL, "red_flag_returned2", "blue_flag_returned2"},
	{NULL, "red_team_scores2", "blue_team_scores2"}
}
...
public plugin_cfg()
{
	...
	{
		new iPosFlag, TeamName:iTeam = TEAM_TERRORIST;
